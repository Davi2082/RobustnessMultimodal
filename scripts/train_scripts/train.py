...
Usage:
    python3 -m scripts.train_scripts.train --model text --dataset Recovery
    python3 -m scripts.train_scripts.train --model image --dataset Recovery
    python3 -m scripts.train_scripts.train --model feature-fusion --dataset Recovery
    python3 -m scripts.train_scripts.train --model svm-rbf --dataset Recovery
    python3 -m scripts.train_scripts.train --model linear --dataset Recovery
"""
...
def require_unimodal_checkpoints(dataset):
    ...
    if missing:
        raise FileNotFoundError(
            ...
            + "\n  ".join(missing)
            + "\nTrain them first: python3 -m scripts.train_scripts.train --model text/image"
        )
