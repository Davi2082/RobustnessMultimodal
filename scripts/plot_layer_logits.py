...
from configuration_files.configuration import SOURCE_LABEL, SUBSET_SIZE
...
def main():
    ...
    dataset = my_datasets.get_dataset(
        ...
        glob.glob(f"data_loading/{args_i.dataset}/test.*")[0], f"data_loading/{args_i.dataset}/images",
    )
