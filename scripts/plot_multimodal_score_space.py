...
from configuration_files.configuration import (  # noqa: E402
    BATCH_SIZE,
    DEVICE_EVAL,
    IMAGE_WEIGHTS_PATH,
    NAME_IMG_EMBED,
...
from configuration_files.paths import (  # noqa: E402
    CLEAN_IMAGE_CSV,
    CLEAN_TEXT_CSV,
    RESULT_PATH,
...
TRAIN_DATA_CSV = "data_loading/Recovery/train_augmented.csv"
TRAIN_IMAGES_DIR = "data_loading/Recovery/images"
